require_relative 'entity_hash'
require 'bulkoperation/active_record/connection_listeners'
require 'bulkoperation/active_record/group_dml'
...
module Bulkoperation::ActiveRecord::ScheduledOperations 
  ...
  class FlushDirtyObjects < TransactionObject
    ...
    def initialize
      @scheduled_merges    = Bulkoperation::ActiveRecord::ScheduledOperations::EntityHash.new
      @scheduled_deletions = Bulkoperation::ActiveRecord::ScheduledOperations::EntityHash.new
    end
